  ...
  return (
    <div className="min-h-screen bg-[#F4F7F5] flex flex-col">
      <div className="flex-1 max-w-3xl mx-auto px-8 py-16 w-full">
        ...
        <h1 className="text-4xl font-semibold text-gray-900 mb-8 fade-up anim-d1">About Sapling</h1>

        <div className="prose prose-gray max-w-none space-y-6 text-gray-600 leading-relaxed">
          <p className="fade-up anim-d2">

...
export function Gallery({
  ...
  return (
    <section id="gallery" style={{ position: 'relative', padding: 'clamp(44px,7vh,92px) 0 clamp(30px,4.5vh,60px)', zIndex: 1, isolation: 'isolate' }}>
      ...
      <div className="ld-gal-head" style={{ position: 'relative', zIndex: 1, maxWidth: 1220, margin: '0 auto', padding: '0 24px', display: 'flex', alignItems: 'flex-end', justifyContent: 'space-between', gap: 24, flexWrap: 'wrap' }}>
        <FadeIn>

...
- backend/services/chunk_visibility.py — `visibility_for` / `record_contributors` / `resync_user_chunk_visibility`: the #629 owner of who may retrieve a `course_chunks` row.

...
def main() -> None:
    ...
    # Explicit, because `visibility` is required (#629): the benchmark's
    # fixture course is meant to be readable by the benchmark's reader.
    count = index_document_chunks(
        BU_CODE, DOC_ID, UPLOADER, chunks, visibility="shared"
    )

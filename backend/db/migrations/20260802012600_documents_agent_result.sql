-- store the document pipeline result so duplicates can replay it
--
-- 20260802012500_documents_file_sha256 added file_sha256 so a re-upload can
-- skip OCR and re-indexing. The
